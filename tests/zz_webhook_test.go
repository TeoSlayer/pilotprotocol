...
func TestWebhookClient_EmptyURL(t *testing.T) {
	...
	wc := webhook.NewClient("", func() uint32 { return 0 })
	if wc != nil {
...
func TestWebhookClient_PostsEvents(t *testing.T) {
	...
	wc := webhook.NewClient(collector.URL(), func() uint32 { return 42 })
	defer wc.Close()
...
func TestWebhookClient_MultipleEvents(t *testing.T) {
	...
	wc := webhook.NewClient(collector.URL(), func() uint32 { return 1 })
...
func TestWebhook_EventPayloadFormat(t *testing.T) {
	...
	wc := webhook.NewClient(collector.URL(), func() uint32 { return 99 })
