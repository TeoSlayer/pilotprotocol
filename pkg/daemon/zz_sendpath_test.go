...
// existing daemon test files can keep the short name. The fixture lives in
// tests/regtestutil to avoid an L7 → L11 layer violation: pkg/daemon
// cannot directly import pkg/registry/server.
