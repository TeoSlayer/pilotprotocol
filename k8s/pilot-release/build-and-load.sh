#!/bin/bash
# Build pilot-release-exporter (arm64) and import to every Jetson node.
# Same pattern as k8s/pilot-probe/build-and-load.sh.
set -euo pipefail

IMAGE="${IMAGE:-pilot-release-exporter:latest}"
